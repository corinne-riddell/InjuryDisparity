...
Guns feature differently into the deaths of black and white Americans
...
```{r figure1, fig.width=4.5, fig.height=6, echo = F, warning=F, fig.align="center"}
...
## Suicide Inequality
```{r figure2, fig.width=4.5, fig.height=6, echo = F, warning=F, fig.align="center"}
...
```{r figure3, fig.width=7.5, fig.height=5, echo = F, warning=F, fig.align="center"}
...
```{r figure4, fig.width=7.5, fig.height=5, echo = F, warning=F, fig.align="center"}
