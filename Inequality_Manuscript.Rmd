...
gun.data <- gun.data %>% arrange(gun.house.prev) %>% mutate(gun.house.prev.category = cut(gun.house.prev, breaks = c(0, 20, 35, 44.9, 66), labels = c("10.2%-19.9%", "20.0%-34.9%", "35.0%-44.9%", "45.0%-65.5%")))
```
...
Males_AllAges_0814 <- merge(Males_AllAges_0814, gun.data, by = "ST")
dim(Males_AllAges_0814)
```
...
```{r figure4, fig.height = 7, fig.width = 5, echo=F, warning=F}
