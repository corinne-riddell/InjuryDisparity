...
```{r figure1, fig.width=6, fig.height=8.5, echo = F, warning=F}
...
###Figure 2: Difference in suicide fatalities rates for men by state, firearms, and race, 2008-2014

```{r figure2, fig.width=6, fig.height=8.5, echo = F, warning=F}
