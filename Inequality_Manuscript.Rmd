...
Using data from all 50 US states and DC, our study illustrates striking variation in the inequality in firearm-related homicide, largely driven by differences among states in homicide rates for black men. Firearm-related suicide inequalities varied across states but to a lesser degree, and was driven by variation in suicide rates for white men. States that were the most dangerous for black men in terms of their risk of homicide were very safe for white men, and included Missouri and the Midwestern states of Michigan, Wisconsin, Illinois, and Indiana. For firearm-related suicide, the states with the largest inequalities were from the South and the West. The states with the lowest inequalities in firearm-related suicide had relatively low rates for black and white men alike, including the Northeastern states of New York, Connecticut, New Jersey, Massachusetts, and the District of Columbia. 

For white men, there is a strong linear relationship between firearm-related homicide and suicide that suggests a shared set of factors affecting both outcomes. The positive association with state gun prevalence is also pronounced. This finding is aligned with the body of research linking gun prevalence or gun ownership to an individual's risk of suicide or homicide victimization (references from intro). Interestingly, discordant states were only found in one direction; There were several states with relatively high rates of firearm-related suicide and relatively low rates of homicide among white men. This "extra" variation in suicide suggests additional characteristics affecting suicide risk in these states that are mostly rural, Western, and isolated. Recent literature has linked limited economic prospects, and rural isolation to suicide risk (references). Given that such states also tend to have high gun availability, residents may live in settings that combine increased risk for suicide attempts with easy access to firearms, the most lethal means for suicide completion [@spicer2000suicide, @miller2004epidemiology]. Such settings can be compared to Northeastern states like New York, Massachusetts, Connecticut and New Jersey, which have the lowest rates of suicide for both black and white men and the fewest firearms. These states also have numerous restrictive gun laws,[@siegel2017firearm] pointing to a multi-faceted environment that has led to the lowest risks for suicide in the country.

The relationship between firearm-related homicide, suicide, and gun prevalence is markedly different for black men. There is no discernible relationship between firearm-related homicide and suicide, suggesting that the factors leading to firearm-related homicide among black men differ from those leading to firearm-related suicide. This may be due to an additional set of factors exclusively affecting either homicide or suicide. Given the substantial variation in homicide among black men across states, it is likely that homicide in the black community is associated with several determinants of homicidal risk that white men do not experience to the same degree, and that do not influence suicidal risk. Such research has found that (references)....Many Southern states have relatively low homicide rates for black men, while Midwestern states with the same level of medium-high gun prevalence have homicidal risks twice as high. Disentangling the factors that make the South relatively safe for black men and the Midwest relatively unsafe for black men (while very safe for white men) is of high priority in order to reduce health inequalities and foster communities that offer equal safety independent of race.
